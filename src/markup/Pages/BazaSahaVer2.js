...
const BazaSahaVer2 = (props) => {
    ...
    useEffect(() => {
        fetch('https://xn--b1amiugdde.xn--p1ai/wp-json/wp/v2/pages/3982')
    ...
    useEffect(() => {
        fetch('https://xn--b1amiugdde.xn--p1ai/wp-json/wp/v2/bgpages/4275')
            .then((response) => response.json())
            .then((data) => {
                setBg3(data.acf.bg);
            });
            ...
            <div className="dlab-bnr-inr overlay-black-light" style={{ backgroundImage: "url(" + bg3 + ")", backgroundSize: 'cover' }}>
                <div className="container">
                    <div className="dlab-bnr-inr-entry">
                        <h1 className="text-white"> Центр экотуризма «Мама–Саха»-«Черный берег под одинокой звездой»</h1>
                ...
                <div className="container">
                    <div className="listing-info-box">
                        <div className="listing-theme-logo">
                            <img src='https://xn--b1amiugdde.xn--p1ai/wp-content/uploads/2022/03/Frame-71.png' alt="" />
                        </div>
                        <div className="listing-info">
                            <div className="listing-info-left">
                                <h3 className="title">"Мама Саха"</h3>
                                <p>Центр экотуризма
                                    «Мама–Саха»-«Черный берег под одинокой звездой»,
                                    расположенный на острове Попова,
                                    в экологически чистом районе,
                                    приглашает Вас на отдых на берегу ласкового моря.
                                </p>
                            </div>
                                                        ...
                                                        <div className="row">
                                                            ...
                                                            <div className="col-md-6 col-xl-4 col-sm-6 col-6">
                                                                <div className="form-group">
                                                                    ...
                                                                    <span className="font-12">Комнаты</span>
                                                                </div>
                                                            </div>
